...
class Student:
    def __init__(self,root):
        ...
        # bg image
        img3=Image.open(r"C:\Users\HP\OneDrive\Desktop\facial recogination system\1628243597666college-images\college_images\wp2551980.jpg")
        ...
        dep_combo["values"]=("Select Department","CSE","IT","CIVIL","MECHNICAL","ELECTRICAL","CSIT","CSDS","CSEAIML")
        dep_combo.current(0)
        ...
        studentid_entry=ttk.Entry(class_student_frame,textvariable=self.va_sid_id,width=20,font=("times new roman",12,"bold"))
        ...
        class_div_combo["values"]=("select division","1","2","3")
        ...
        # image
        img_right=Image.open(r"fr5.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_sid_id.get()=="":
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_sid_id.get()=="":
            ...
            try:
                ...
                if Upadate:
                    ...
                    messagebox.showinfo("success","Studenet details successfully updated ",parent=self.root)
                    conn.commit()
                    self.fetch_data()
                    conn.close()
                else:
        ...
        if self.va_sid_id.get()=="":
            ...
            try:
                ...
                if delete:
                    ...
                    val=(self.va_sid_id.get(),)
                    my_cursor.execute(sql,val)
                    messagebox.showinfo("success","Studenet details successfully deleted",parent=self.root)
                    conn.commit()
                    self.fetch_data()
                    conn.close()
                else:
